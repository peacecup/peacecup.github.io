  ...
  $.ajax({
    ...
    success: function (res) {
      ...
      resultContent.innerHTML =
        '<div id="no-result"><i class="icon icon-search icon-5x" /></div>'
      var inputEventFunction = function () {
          ...
          datas.forEach(function (data) {
            ...
            if (title != '') {
              keywords.forEach(function (keyword) {
                ...
                indexOfTitle = indexOfTitle.concat(
                  getIndexByWord(keyword, titleInLowerCase,
                    false));
            ...
            if (isMatch) {
              ...
              function mergeIntoSlice(text, start, end, index) {
                ...
                while (position + word.length <= end && index.length !=
                  0) {
                  if (word === searchText) {
              ...
              if (indexOfTitle.length != 0) {
                slicesOfTitle.push(mergeIntoSlice(title, 0, title
                  .length, indexOfTitle));
              }
              var slicesOfContent = [];
              ...
              slicesOfContent.sort(function (sliceLeft,
                ...
                if (sliceLeft.searchTextCount !== sliceRight.searchTextCount) {
                  ...
                  return sliceRight.hits.length - sliceLeft.hits
                    .length;
                } else {
        ...
        if (keywords.length === 1 && keywords[0] === "") {
          ...
          resultContent.innerHTML =
            '<div id="no-result"><i class="icon icon-frown-o icon-5x" /></div>'
        } else {
