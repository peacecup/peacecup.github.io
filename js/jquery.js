...
(function (window, undefined) {
  ...
  jQuery.support = (function () {
    ...
    jQuery(function () {
      ...
      support.doesNotIncludeMarginInBodyOffset = (body.offsetTop !==
        1);
  ...
  jQuery.extend({
    ...
    attr: function (elem, name, value) {
      ...
      } else if (hooks && notxml && "get" in hooks && (ret = hooks.get(
          elem, name)) !== null) {
        return ret;
      } else {
  ...
  if (!getSetAttribute) {
    ...
    nodeHook = jQuery.valHooks.button = {
      get: function (elem, name) {
        var ret = elem.getAttributeNode(name);
        return ret && (name === "id" || name === "name" || name ===
            "coords" ? ret.value !== "" : ret.specified) ?
          ret.value :
          undefined;
      },
      set: function (elem, value, name) {
  ...
  jQuery.event = {
    ...
    add: function (elem, types, handler, data, selector) {
      var handleObjIn, eventHandle, tmp,
        ...
        elemData = elem.nodeType !== 3 && elem.nodeType !== 8 && jQuery._data(
          elem);
      if (!elemData) {
        return;
      }
  ...
  if (!jQuery.support.submitBubbles) {
    jQuery.event.special.submit = {
      setup: function () {
        ...
        jQuery.event.add(this, "click._submit keypress._submit", function (
          e) {
        ...
        jQuery.event.add(this, "beforeactivate._change", function (e) {
          ...
          if (rformElems.test(elem.nodeName) && !jQuery._data(elem,
            ...
            jQuery.event.add(elem, "change._change", function (event) {
              if (this.parentNode && !event.isSimulated && !event
                .isTrigger) {
  ...
  (function (window, undefined) {
      ...
      sortOrder = docElem.compareDocumentPosition ?
        function (a, b) {
          ...
          if ((compare = b.compareDocumentPosition && a.compareDocumentPosition &&
            ...
            if (compare & 1 || a.parentNode && a.parentNode.nodeType ===
              11) {
        ...
        function (a, b) {
          ...
          if (a === b) {
            ...
            return (~b.sourceIndex || MAX_NEGATIVE) - (contains(
              preferredDoc, a) && ~a.sourceIndex || MAX_NEGATIVE);
    ...
    Sizzle.attr = function (elem, name) {
      ...
      return ((val = elem.getAttributeNode(name)) || elem.getAttribute(
          name)) && elem[name] === true ?
        name :
        ...
        "ATTR": function (name, operator, check) {
          return function (elem) {
            ...
            return operator === "=" ? result === check :
              ...
              -1 :
              operator === "|=" ? result === check || result.substr(0,
    ...
    function select(selector, context, results, seed) {
      ...
      if (!seed) {
        ...
        if (match.length === 1) {
          ...
          for (i = matchExpr["needsContext"].test(selector) ? -1 : tokens.length -
            1; i >= 0; i--) {
            token = tokens[i];
    ...
    domManip: function (args, table, callback) {
      ...
      if (isFunction || !(l <= 1 || typeof value !== "string" || jQuery
        ...
        return this.each(function (index) {
          ...
          if (isFunction) {
            args[0] = value.call(this, index, table ? self.html() :
              undefined);
          }
          ...
          if (hasScripts) {
            ...
            for (i = 0; i < hasScripts; i++) {
              ...
              if (rscriptType.test(node.type || "") &&
                !jQuery._data(node, "globalEval") && jQuery.contains(
                  doc, node)) {
                if (node.src) {
  ...
  function findOrAppend(elem, tag) {
    return elem.getElementsByTagName(tag)[0] || elem.appendChild(elem.ownerDocument
      .createElement(tag));
  }
  ...
  function getAll(context, tag) {
    var elems, elem,
      i = 0,
      found = typeof context.getElementsByTagName !== "undefined" ? context.getElementsByTagName(
        tag || "*") :
      typeof context.querySelectorAll !== "undefined" ? context.querySelectorAll(
        tag || "*") :
      undefined;
    if (!found) {
        ...
        if (elem || elem === 0) {
          ...
          if (jQuery.type(elem) === "object") {
            ...
            if (!jQuery.support.leadingWhitespace && rleadingWhitespace
              .test(elem)) {
              nodes.push(context.createTextNode(rleadingWhitespace.exec(
                elem)[0]));
            }
    ...
    for (; index < length; index++) {
      ...
      if (show) {
        ...
        if (elem.style.display === "" && isHidden(elem)) {
          values[index] = jQuery._data(elem, "olddisplay", css_defaultDisplay(
            elem.nodeName));
        }
  ...
  if (jQuery.expr && jQuery.expr.filters) {
    jQuery.expr.filters.hidden = function (elem) {
      return (elem.offsetWidth === 0 && elem.offsetHeight === 0) || (!
        jQuery.support.reliableHiddenOffsets && ((elem.style && elem.style
  ...
  function defaultPrefilter(elem, props, opts) {
    ...
    if (elem.nodeType === 1 && ("height" in props || "width" in props)) {
      ...
      if (jQuery.css(elem, "display") === "inline" &&
        ...
        if (!jQuery.support.inlineBlockNeedsLayout || css_defaultDisplay(elem
            .nodeName) === "inline") {
